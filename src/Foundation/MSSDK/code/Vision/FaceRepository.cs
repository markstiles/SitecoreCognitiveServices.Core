...
namespace SitecoreCognitiveServices.Foundation.MSSDK.Vision
{
    public class FaceRepository : IFaceRepository
    {
        ...
        public virtual IdentifyResult[] Identify(string personGroupId, Guid[] faceIds, int maxNumOfCandidatesReturned = 1) {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}identify", JsonConvert.SerializeObject(new IdentifyRequest { PersonGroupId = personGroupId, FaceIds = faceIds, ConfidenceThreshold = 0.5f, MaxNumOfCandidatesReturned = 1 }));
        ...
        public virtual async Task<IdentifyResult[]> IdentifyAsync(string personGroupId, Guid[] faceIds, int maxNumOfCandidatesReturned = 1) {
            var response = await RepositoryClient.SendJsonPostAsync(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}identify", JsonConvert.SerializeObject(new IdentifyRequest { PersonGroupId = personGroupId, FaceIds = faceIds, ConfidenceThreshold = 0.5f, MaxNumOfCandidatesReturned = 1}));
        ...
        {
            var response = RepositoryClient.SendJsonPut(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}", JsonConvert.SerializeObject(new UserDataRequest { Name = name, UserData = userData }));
        ...
        {
            var response = await RepositoryClient.SendJsonPutAsync(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}", JsonConvert.SerializeObject(new UserDataRequest { Name = name, UserData = userData }));
        ...
        {
            var response = RepositoryClient.SendJsonPost(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}/train", string.Empty);
        ...
        {
            var response = await RepositoryClient.SendJsonPostAsync(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}/train", string.Empty);
        ...
        {
            var response = RepositoryClient.SendJsonPatch(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}/persons/{personId}", JsonConvert.SerializeObject(new UserDataRequest { Name = name, UserData = userData }));
        ...
        {
            var response = await RepositoryClient.SendJsonPatchAsync(ApiKeys.Face, $"{ApiKeys.FaceEndpoint}persongroups/{personGroupId}/persons/{personId}", JsonConvert.SerializeObject(new UserDataRequest { Name = name, UserData = userData }));
