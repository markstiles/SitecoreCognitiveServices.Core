...
namespace SitecoreCognitiveServices.Foundation.SCSDK.Services.NexSDK
{
    public interface ISessionService
    {
        ...
        Task<SessionResponse> CreateForecast(ForecastSessionRequest request);
        ...
        Task<SessionResponse> AnalyzeImpact(ImpactSessionRequest request);
        ...
        Task<SessionResponse> TrainModel(ModelSessionRequest request);
        ...
        Task<SessionResponseList> List(SessionQuery query = null);
        ...
        Task Remove(SessionRemoveCriteria criteria);
        ...
        Task<SessionResult> GetResults(Guid id, SessionResultsQuery query = null);
        ...
        /// <exception cref="NexosisClientException">Thrown when 4xx or 5xx response is received from server, or errors in parsing the response.</exception>
        Task<ConfusionMatrixResult> GetResultConfusionMatrix(Guid id);
        ...
        /// <returns>A <see cref="SessionResult"/> which contains the results of the run.</returns>
        /// <exception cref="NexosisClientException">Thrown when 4xx or 5xx response is received from server, or errors in parsing the response.</exception>
        Task<SessionResult> GetResultAnomalyScores(Guid id);
        ...
        /// <returns>A <see cref="SessionResult"/> which contains the results of the run.</returns>
        /// <exception cref="NexosisClientException">Thrown when 4xx or 5xx response is received from server, or errors in parsing the response.</exception>
        Task<SessionResult> GetResultClassScores(Guid id);
    }
}